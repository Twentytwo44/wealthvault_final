...
import com.wealthvault.data.portfolio.insurance.transport.requireSuccess
...
class DeleteInsuranceApiImpl(private val client: HttpClient) : DeleteInsuranceApi {
    ...
    override suspend fun deleteInsurance(id: String) {
        ...
        }.body<com.wealthvault.data.portfolio.insurance.transport.model.DeleteInsuranceResponse>().requireSuccess()
    }
}
