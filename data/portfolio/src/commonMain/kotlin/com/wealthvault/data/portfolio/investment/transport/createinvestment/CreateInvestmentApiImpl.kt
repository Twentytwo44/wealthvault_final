...
import com.wealthvault.data.portfolio.investment.transport.toWire
...
class CreateInvestmentApiImpl(private val client: HttpClient) : CreateInvestmentApi {
    override suspend fun create(request: InvestmentRequest): InvestmentData {
        ...
        }.body<com.wealthvault.data.portfolio.investment.transport.model.InvestmentResponse>().requireDomainData()
    }
}
