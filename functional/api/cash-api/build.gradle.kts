...
kotlin {
    ...
    androidLibrary {
        namespace = "com.wealthvault.cash_api"
        compileSdk = 36
        minSdk = 24
    ...
    sourceSets {
        commonMain {
            ...
            dependencies {
                ...
                // The adapter maps legacy cash wire DTOs to domain contracts so
                // feature/data consumers never need to import transport models.
