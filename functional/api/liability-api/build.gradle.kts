...
kotlin {
    ...
    androidLibrary {
        namespace = "com.wealthvault.liability_api"
        compileSdk = 36
        minSdk = 24
    ...
    sourceSets {
        commonMain {
            ...
            dependencies {
                ...
                // Legacy liability wire values are mapped to domain contracts
                // inside this adapter before reaching feature/data callers.
