...
kotlin {
    ...
    androidLibrary {
        namespace = "com.wealthvault.insurance_api"
        compileSdk = 36
        minSdk = 24
    ...
    sourceSets {
        commonMain {
            ...
            dependencies {
                ...
                // Map legacy insurance wire DTOs to domain contracts inside
                // this adapter before returning values to consumers.
