...
kotlin {
    ...
    androidLibrary {
        namespace = "com.wealthvault.account_api"
        compileSdk = 36
        minSdk = 24
    ...
    sourceSets {
        commonMain {
            ...
            dependencies {
                ...
                // Keep legacy wire DTO mapping inside the adapter and expose
                // only portfolio domain contracts to data/feature consumers.
