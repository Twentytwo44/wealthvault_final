...
fun BankAccountInputForm(
    ...
    Scaffold(
        ...
        Column(
            ...
            AssetTextField(value = bankId, onValueChange = { bankId = it }, label = "เลขบัญชี*", placeholder = "กรอกเลขบัญชี")
            AssetTextField(value = amount, onValueChange = { amount = it }, label = "จำนวน*", placeholder = "0.00")
