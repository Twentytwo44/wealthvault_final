...
fun ExpenseInputForm(
    ...
    Scaffold(
        ...
        Column(
            ...
            AssetTextField(value = creditor, onValueChange = { creditor =it }, label = "ผู้รับผิดชอบ*", placeholder = debtData?.creditor.toString())
            AssetTextField(value = statedAt, onValueChange = { statedAt = it }, label = "วันที่เริ่มต้น*", placeholder = debtData?.startedAt ?: "")
